...
public class ModelAbsorber extends EntityModel<Player> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(AncientTweaks.MODID, "absorber"), "main");
    ...
    public void render(Player player, PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float alpha) {
        ...
        this.backpack.render(poseStack, vertexConsumer, packedLight, packedOverlay);
