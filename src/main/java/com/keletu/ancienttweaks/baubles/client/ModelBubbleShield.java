...
public class ModelBubbleShield extends EntityModel<LivingEntity> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(AncientTweaks.MODID, "bubble_shield"), "main");
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
        this.bubble.render(poseStack, vertexConsumer, packedLight, packedOverlay);
    }

    public void render(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, float alpha) {
        poseStack.pushPose();

        this.bubble.render(poseStack, vertexConsumer, packedLight, OverlayTexture.NO_OVERLAY, 0x80FFFFFF);
