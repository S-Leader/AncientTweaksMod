...
public class LayerTheAbsorber extends RenderLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(AncientTweaks.MODID, "textures/layer/the_absorber_model.png");
    ...
    private static boolean hasTheAbsorber(AbstractClientPlayer player) {
        return CuriosApi.getCuriosInventory(player).flatMap(handler -> handler.findFirstCurio(ATItems.theAbsorber.get())).isPresent();
    }
}