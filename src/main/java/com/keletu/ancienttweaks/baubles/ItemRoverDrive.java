...
public class ItemRoverDrive extends Item implements ICurioItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Item.TooltipContext level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("tooltip.ancienttweaks.roverDrive1", AncientTweaksConfig.CONFIG_CALAMITY.roverDriveShieldCount.get()).withStyle(ChatFormatting.DARK_GRAY));

        tooltip.add(Component.empty());

        tooltip.add(Component.translatable("tooltip.ancienttweaks.roverDrive2", AncientTweaksConfig.CONFIG_CALAMITY.roverDriveShieldCooldown.get()).withStyle(ChatFormatting.DARK_GRAY));

        tooltip.add(Component.translatable("tooltip.ancienttweaks.roverDrive3").withStyle(ChatFormatting.DARK_GRAY));
    }
}
