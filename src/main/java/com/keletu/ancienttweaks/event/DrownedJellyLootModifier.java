...
public class DrownedJellyLootModifier extends LootModifier {
    ...
    public static final MapCodec<DrownedJellyLootModifier> CODEC = RecordCodecBuilder.mapCodec(instance -> codecStart(instance).apply(instance, DrownedJellyLootModifier::new));
